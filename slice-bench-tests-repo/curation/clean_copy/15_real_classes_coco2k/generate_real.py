...
ann = '/home/jxu680/data-slicing-pipeline/mm-post-processing/1-pair-bboxes/coco_2014_val_nov1_pair1'
idir = '/data/users/jie/data-slicing/COCO/val2014/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_boxes', '-n', type=int, default=1000)
    parser.add_argument('--n_classes', '-c', type=int, default=15)
    parser.add_argument('--injection', '-i', type=str, default='kmeans_20')
