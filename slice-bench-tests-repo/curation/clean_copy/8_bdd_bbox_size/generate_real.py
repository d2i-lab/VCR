...
ann = '/home/jxu680/data-slicing-pipeline/mm-post-processing/1-pair-bboxes/bdd_feb_27_full_pair1'
idir = '/data/users/jie/data-slicing/bdd100k/bdd_select'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--injection', '-i', type=str, default='box_area_range')
